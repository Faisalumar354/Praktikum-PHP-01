...
<head>
    ...
    <title>Praktikum PHP Bagian 2</title>
...
<body>
        ...
        <div class="container-fluid bg-light p-5  shadow-sm">
            <div class="row">
              <div class="col-8">
                <form method="POST" action="oke.php" class="form-horizontal ">
                  <h1 class="text-primary">IndoMarket</h1>
                  <hr>
                  <div class="form-group row">
                    <label for="nama__customer" class="col-sm-4 col-form-label"><b>Nama Pemesan</b></label>
                    <div class="col-sm-8">
                ...
                <!------------------------>
                  ...
                  <fieldset class="form-group">
                    <div class="row">
                      <legend class="col-form-label col-sm-4 pt-0"><b>Barang</b></legend>
                      <div class="col-sm-8">
                  ...
                  <div class="form-group row">
                    <label for="jumlah__" class="col-sm-4 col-form-label"><b>Jumlah Pesanan</b></label>
                    <div class="col-sm-5">
              ...
              <div class="col-4 " >
                  <ul class="p-1 bg-white" style="list-style-type:none;border:1px solid #c4c4c4;">
                    <li class="bg-primary p-2 text-white">Daftar Barang</li>
                    <li class="p-2">TV : 5.000.000</li>
