...
<body>
        ...
        <div class="container-fluid bg-light p-5  shadow-sm">
            <div class="row">
              <div class="col-8">
                <form method="POST" action="Fromkuyy.php" class="form-horizontal ">
                  <h1 class="text-primary">Form Nilai</h1>
                  <hr>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    <label for="nilai_tugas" class="col-sm-4 col-form-label"><b>Nilai Tugas / Praktikum</b></label>
                    <div class="col-sm-2">
                   ...
                   <button href="" type="submit" class="btn btn-primary pl-5 pr-5" name="proses">Selesai</button>
                </form>
              </div> <!-----col-6-->
